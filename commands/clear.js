module.exports = {
    run: async (message, args) => {
        ...
        if (count < 1 || count > 200) return message.channel.send('Le nombre de message doit être compris entre 1 et 200.')
    ...
    guildOnly: true,
    help: {
        description: 'Cette commande permet de supprimer entre 1 et 200 messages.',
